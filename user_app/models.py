...
class UserInfo(models.Model):
    ...
    head_img = models.ImageField(upload_to='static/images/heads', default='static/images/heads/product_img_17.png', verbose_name='头像')
    t_name = models.CharField(max_length=10, null=True, verbose_name='真实姓名', blank=True)
    gender = models.IntegerField(choices=sex, default=1, verbose_name='性别')
    email = models.EmailField(null=True, verbose_name='邮箱', blank=True)
